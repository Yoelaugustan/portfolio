...
const About = ({isDarkMode}) => {
  return (
    <div id="about" className='w-full px-[12%] py-10 scroll-mt-20'>
      <h4 className={`${ovo.className} text-center mb-2 text-lg`}>Introduction</h4>
        ...
        <div className='flex-1'>
            ...
            <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                {infoList.map(({icon, iconDark, title, description}, index)=>(
                    <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-light-hover hover:-translate-y-1 duration-500 hover:black-shadow dark:border-white dark:hover:black-shadow dark:hover:bg-dark-hover/50' key={index}>
            ...
            <h4 className={`${ovo.className} mt-6 text-gray-700 dark:text-white/80`}>Tools I used</h4>
